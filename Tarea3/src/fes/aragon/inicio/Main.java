...
public class Main {
    public static void main(String[] args) {
        ...
        Nodo<Integer>  head = new Nodo<>(100, new Nodo<>(200 , new Nodo<>(300 ,
                new Nodo<>(400 , new Nodo<>(600 , null)))));
        ...
        Nodo<Integer> nodo600 = head3.getSiguiente().getSiguiente().getSiguiente()
                .getSiguiente();
        ...
        System.out.print("Estructura con 50 al principio:");
        System.out.println();
        while (aux1 != null) {
